...
/obj/item/robot_suit/update_icon()
	cut_overlays()
	if(l_arm)
		add_overlay("[initial(l_arm.icon_state)]+o")
	if(r_arm)
		add_overlay("[initial(r_arm.icon_state)]+o")
	if(chest)
		add_overlay("[initial(chest.icon_state)]+o")
	if(l_leg)
		add_overlay("[initial(l_leg.icon_state)]+o")
	if(r_leg)
		add_overlay("[initial(r_leg.icon_state)]+o")
	if(head)
		add_overlay("[initial(head.icon_state)]+o")
